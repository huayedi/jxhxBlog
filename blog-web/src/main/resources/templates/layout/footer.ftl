...
<#--<a class="to-top" title="点击返回顶部" data-toggle="tooltip" data-placement="bottom">-->
</a>
<div class="to-top">
    <span class="to-top-line" style="height: 50%; left: 3px; transform: rotateZ(45deg);"></span>
    <span class="to-top-line" style="height: 100%;  transform: rotateZ(0deg);"></span>
    <span class="to-top-line" style="height: 50%; left: -3px; transform: rotateZ(-45deg);"></span>
</div>
